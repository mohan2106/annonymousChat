...
public class RequestFragment extends Fragment {
    ...
    public void onStart() {
        ...
        databaseReference.child("friends").child(mAuth.getUid()).addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for(DataSnapshot snapshot : dataSnapshot.getChildren()){
                    mentorLsit.add(new friendsClass( snapshot.getKey(), "10 months"));
